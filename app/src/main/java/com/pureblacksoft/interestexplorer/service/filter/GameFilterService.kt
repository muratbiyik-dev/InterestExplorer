...
class GameFilterService : FilterService(TAG, onSuccess, onFailure) {
    companion object {
        private const val TAG = "GameFilterService"

        private const val SERVICE_ID = 311
        ...
        fun enqueueWork(context: Context, intent: Intent) {
            enqueueWork(context, GameFilterService::class.java, SERVICE_ID, intent)
        }
    }
